...
from models import User, Link, Asset
...
def dashboard(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("dashboard.html", {
        ...
        "links": links, "assets": assets, "active_page": "dashboard"
    })


# â”€â”€ Add Link â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def add_link(
    ...
    new_link = Link(
        ...
        url=url or None, icon=icon or None,
        is_section=False, sort_order=max_order
    )
    db.add(new_link)
    db.commit()
...
# â”€â”€ Add Section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def add_section(
    ...
    section = Link(
        user_id=user.id, title=title,
        url=None, icon=None,
        is_section=True, sort_order=max_order
    )
    db.add(section)
    db.commit()
    return RedirectResponse(url="/dashboard", status_code=302)
...
# â”€â”€ Delete Link/Section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Toggle Link â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def toggle_link(link_id: int, request: Request, db: Session = Depends(get_db)):
    ...
    if link and not link.is_section:
        link.is_active = not link.is_active; db.commit()
    return RedirectResponse(url="/dashboard", status_code=302)
...
# â”€â”€ Reorder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Upload Asset â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def upload_asset(
    ...
    if ext not in ALLOWED_EXTENSIONS:
        return JSONResponse({"error": f"File type not allowed."}, status_code=400)
    ...
    asset = Asset(user_id=user.id, filename=unique_name, label=label or os.path.splitext(file.filename or "")[0][:100], url=asset_url)
...
# â”€â”€ My Assets Page â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def assets_page(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("assets.html", {
        "request": request, "user": user,
        "assets": assets, "active_page": "assets"
    })
